#Provision WildFly 10.0.0

#If file is already downloaded and saved to /vagrant we reuse it
cp /vagrant/wildfly-10.0.0.Final.tar.gz wildfly-10.0.0.Final.tar.gz
...
#Enable debug mode
sudo sed -i -e 's,DEBUG:-false,DEBUG:-true,g' /opt/wildfly/bin/standalone.sh
sudo service wildfly restart

wget -q https://jdbc.postgresql.org/download/postgresql-9.4.1208.jar
